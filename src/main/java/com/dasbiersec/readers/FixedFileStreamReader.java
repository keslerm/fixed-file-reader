 ...
 *
 */
public class FixedFileStreamReader extends InputStreamReader
{
	private int count = 1;
	private int lineLength = 0;

	public FixedFileStreamReader(String s) throws FileNotFoundException
	{
		super(new FileInputStream(s));
	}

	public FixedFileStreamReader(String s, String enc) throws FileNotFoundException, UnsupportedEncodingException
	{
